...
Mat은 초기화 방법이 여러개있음 근데 전부다 행렬만드는 거인건 똑같음.
Mat, Mat_, Matx 선언가능 Mat을 Mat::ones,zeros,eye로 초기화가능, Mat_는 들어갈 타입을 지정하니까 <<연산자로 바로 값을 넣을 수있기에 초기화가 쉬움, Matx는 작은 크기의 행렬 1*1 ~ 6*6까지 만들기 쉬움
